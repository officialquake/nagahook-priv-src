...
void AntiAimInfo(CUserCmd* cmd, C_BaseEntity* local, C_BaseCombatWeapon* weapon, bool& bPacket)
{
    ...
    draw->drawstring(50, 985, realAngleBuf, espfont, Color::Green()); // Real Angle
    draw->drawstring(50, 1000, fakeAngleBuf, espfont, Color::Red());  // Fake Angle
    draw->drawstring(50, 1015, lbyAngleBuf, espfont, Color::Blue());  // Lower Body Angle
