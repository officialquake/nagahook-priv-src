...
unordered_map<int, cSkin> cSkinchanger::Skins = unordered_map<int, cSkin>( {
    ...
    // Pistols
    make_pair(WEAPON_CZ75A, cSkin(skin.cz, -1, -1, -1, 0, nullptr, 0.0001f)), // Tuxedo
    make_pair(WEAPON_DEAGLE, cSkin(skin.deagle, -1, -1, 1337, 0, (char*)("1'd"), 0.0001f)), // Code Red
    make_pair(WEAPON_ELITE, cSkin(skin.dual, -1, -1, 1337, 0, nullptr, 0.0001f)), // Shred
    make_pair(WEAPON_FIVESEVEN, cSkin(skin.five7, -1, -1, 1337, 0, nullptr, 0.0001f)), // Case Hardended
    make_pair(WEAPON_GLOCK, cSkin(skin.glock, -1, -1, 1337, 0, nullptr, 0.0001f)), // Fade
    make_pair(WEAPON_HKP2000, cSkin(skin.p2000, -1, -1, 1337, 0, nullptr, 0.0001f)), // Ocean Foam (P2000)
    make_pair(WEAPON_P250, cSkin(skin.p250, -1, -1, -1, 0, nullptr, 0.0001f)), // Whiteout
    make_pair(WEAPON_REVOLVER, cSkin(skin.revolver, -1, -1, -1, 0, nullptr, 0.0001f)), // Crimson Web
    ...
    make_pair(WEAPON_MP7, cSkin(skin.mp7, -1, -1, -1, 0, nullptr, 0.0001f)), // Cirrus
    make_pair(WEAPON_MP9, cSkin(skin.mp9, -1, -1, -1, 0, nullptr, 0.0001f)), // Bioleak
    make_pair(WEAPON_P90, cSkin(skin.p90, -1, -1, -1, 0, nullptr, 0.0001f)), // Shallow Grave
    make_pair(WEAPON_MP5, cSkin(39, -1, -1, -1, 0, nullptr, 0.0001f)), // Bulldozer
    make_pair(WEAPON_UMP45, cSkin(skin.ump, -1, -1, -1, 0, nullptr, 0.0001f)), // Grand Prix
    make_pair(WEAPON_BIZON, cSkin(skin.bizon, -1, -1, -1, 0, nullptr, 0.0001f)), // Rust Coat
    // Heavy
    make_pair(WEAPON_MAG7, cSkin(skin.mag7, -1, -1, -1, 0, nullptr, 0.0001f)), // Hard Water
    make_pair(WEAPON_NOVA, cSkin(skin.nova, -1, -1, -1, 0, nullptr, 0.0001f)), // Exo
    make_pair(WEAPON_SAWEDOFF, cSkin(skin.sawed, -1, -1, -1, 0, nullptr, 0.0001f)), // Wasteland Princess
    make_pair(WEAPON_XM1014, cSkin(skin.xm, -1, -1, -1, 0, nullptr, 0.0001f)), // Seasons
    make_pair(WEAPON_M249, cSkin(skin.m249, -1, -1, -1, 0, nullptr, 0.0001f)), // Emerald Posion Dart
    make_pair(WEAPON_NEGEV, cSkin(skin.negev, -1, -1, -1, 0, nullptr, 0.0001f)), // Loudmouth
});
